...
interface LoadingScreenProps {
  ...
  /** Matches marketing landing (light + lemon) when set. */
  theme?: "default" | "ethio";
}
...
export function LoadingScreen({
  ...
  const isEthio = theme === "ethio";
  return (
    <div
      className={
        isEthio
          ? "absolute inset-0 flex items-center justify-center bg-[hsl(80,30%,97%)]"
          : "absolute inset-0 flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900"
      }
    >
      <motion.div
      ...
      >
        ...
        <motion.p
          ...
          className={
            isEthio
              ? "text-[hsl(222,20%,40%)] text-sm mb-4"
        ...
        >
          <div
            className={
              isEthio
                ? "flex justify-between text-xs text-[hsl(222,20%,40%)] mb-2"
                : "flex justify-between text-xs text-slate-500 mb-2"
            }
          >
          ...
          <div
            className={
              isEthio
                ? "w-full bg-slate-200/90 rounded-full h-2 overflow-hidden"
          ...
          >
            <motion.div
              className={
                isEthio
                  ? "h-full bg-gradient-to-r from-lime-400 to-[hsl(210,95%,28%)] rounded-full"
                  : "h-full bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-400 rounded-full"
              }
              initial={{ width: 0 }}
