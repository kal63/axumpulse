...
export function XPChart({ data, summary, onPeriodChange }: XPChartProps) {
  ...
  const CustomTooltip = ({ active, payload }: any) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div className="user-app-paper p-4 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
          <p className="text-sm font-medium user-app-ink mb-2">
          ...
          {chartType === 'daily' ? (
            <>
              ...
              {data.breakdown && (
                <div className="mt-2 space-y-1 text-xs user-app-muted">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            {summary && (
              <div className="mt-2 flex items-center gap-4 text-sm user-app-muted">
        ...
        {/* Chart */}
        {chartData.length === 0 ? (
          <div className="h-64 flex items-center justify-center user-app-muted">
        ...
        {summary && chartData.length > 0 && (
          <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            <div className="text-center">
              <p className="text-sm user-app-muted">Total XP</p>
              <p className="text-2xl font-bold user-app-ink mt-1">
